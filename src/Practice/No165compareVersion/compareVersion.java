package Practice.No165compareVersion;
...
//    内存消耗：36.5 MB, 在所有 Java 提交中击败了52.98%的用户
    public static int compareVersion(String version1, String version2) {
        ...
        try {
            ...
            if (AllZero(v1,v2.length)){
                return 0;
            } else  {
            return 1;
            }
        }
        if (v1.length<v2.length && !AllZero(v2,v1.length) ){
            return -1;
        }
        return 0;
    }
    public static boolean AllZero(String[] str,int l){
